  ...
  return (
    <div className="relative h-[100dvh] w-full overflow-x-clip">
      ...
      <div className="absolute z-10 flex h-full w-full items-center justify-center">
        <div className="max-w-[1200px] grid-cols-2 rounded-2xl bg-white/70 lg:grid">
          <section
            className="m-2 hidden flex-col gap-18 rounded-2xl px-6 pt-20 pb-10 lg:flex"
            style={{
              background:
          ...
          <section className="flex flex-col gap-10 px-10 py-12 md:px-28">
