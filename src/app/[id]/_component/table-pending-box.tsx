...
export default function TablePendingBox({ startOffset, endOffset }: TablePendingBoxProps) {
  return (
    <div
      className="border-classpick-500 bg-classpick-200/20 absolute left-[10px] z-20 flex h-full w-[calc(100%-20px)] items-center justify-center rounded-md border-2 backdrop-blur-[2px]"
      style={{
